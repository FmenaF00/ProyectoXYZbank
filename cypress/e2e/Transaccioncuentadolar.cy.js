describe('Home of www.globalsqa.com/angularJs-protractor/BankingProject/#/login', () => { 
    ...
    it('Cuenta dollar realizar un deposito', () => {
    ...
    //('Cuenta dollar realizar un deposito usando las flechas para sumar el monto', () => {
        cy.get('.borderM > :nth-child(1) > .btn').click();
        cy.xpath('//*[@id="userSelect"]').select('Hermoine Granger');
        cy.get('form.ng-valid > .btn').click();
        cy.get('#accountSelect').select('1001');
    ...
    //('Cuenta dollar realizar un deposito usando las flechas para restar el monto', () => {
        cy.get('.borderM > :nth-child(1) > .btn').click();
        cy.xpath('//*[@id="userSelect"]').select('Hermoine Granger');
        cy.get('form.ng-valid > .btn').click();
        cy.get('#accountSelect').select('1001');
    ...
    //('Cuenta dollar realizar un debito', () => {
        cy.get('.borderM > :nth-child(1) > .btn').click();
        cy.xpath('//*[@id="userSelect"]').select('Hermoine Granger');
        cy.get('form.ng-valid > .btn').click();
        cy.get('#accountSelect').select('1001');
    ...
    //('Cuenta dollar realizar un debito usando las flechas para sumar el monto', () => {
        cy.get('.borderM > :nth-child(1) > .btn').click();
        cy.xpath('//*[@id="userSelect"]').select('Hermoine Granger');
        cy.get('form.ng-valid > .btn').click();
        cy.get('#accountSelect').select('1001');
    ...
    //('Cuenta dollar realizar un debito usando las flechas para restar el monto', () => {
        cy.get('.borderM > :nth-child(1) > .btn').click();
        cy.xpath('//*[@id="userSelect"]').select('Hermoine Granger');
        cy.get('form.ng-valid > .btn').click();
        cy.get('#accountSelect').select('1001');
    ...
    //('Verificación de las transacciones anteriores', () => {
        ...
        cy.get('#start').click()
        cy.get('input#start').clear().type(startDate).should('have.value', startDate);
        cy.get('input#start').invoke('attr', 'min').should('eq', '2015-01-01T00:00:00');
